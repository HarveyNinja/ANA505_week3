...
weight <- select(.data = women1,c(2))
women1 %>% select(height)
...
womendata <- tibble(height_data = height,
                    weight_data = weight)
womendata
